...
public class JobSeekerSaveController {
    ...
    public String save(@PathVariable("id") int id, JobSeekerSave jobSeekerSave) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            Users currentUser = usersService.findByEmail(user);
    ...
    public String savedJobs(Model model) {
        ...
        List<JobSeekerSave> candidatesJobsList = jobSeekerSaveService.getCandidatesJobs((JobSeekerProfile) currentUser);
        for (JobSeekerSave jobSeekerSave : candidatesJobsList) {
